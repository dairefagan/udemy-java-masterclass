...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out
        .println("The account phone number is : " + current.getCustomerPhoneNumberString() + ".");

    System.out.println("\n******************************************************\n");

    Account savings = new Account("87654321", 100_000, "Dáire Fagan", "daire@java.com",
        "0877654321");
    ...
    System.out
        .println("The account phone number is : " + savings.getCustomerPhoneNumberString() + ".");
    ...
    Account student = new Account("Dáire Fagan", "daire@udemy.com", "43215678");
    System.out.println(student.getNumber() + " name " + student.getCustomerEmailAddress());
  }
