...
public class Car extends Vehicle {
	...
	public Car(int wheels, int numberOfSeats, String colour, String manufacturer, String model, String engineType, String transmissionType, Boolean ABS,
	...
	public void printDetails() {
		...
		System.out.println("The " + manufacturer + " " + model + " transmission type is " + transmissionType + ".");
		...
		System.out.println("The " + manufacturer + " " + model + " currently has gear " + gear + " selected.");
		System.out.println("The " + manufacturer + " " + model + " is currently steering " + steering + ".");
	}
	...
	public void changeGear(int newGear) {
		...
		this.gear = newGear;
		System.out.println("The " + manufacturer + " " + model + " now has gear " + gear + " selected.");
